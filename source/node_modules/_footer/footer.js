...
function FooterComponent (state) {
  s = s ? s : styling(`
    ...
    .impressum {
      ...
      color             : ${state.theme.colors.mediumgrey2};
    }
    .link {
      font-size         : ${state.theme.font.small+'px'};
      font-family       : ${state.theme.font.avenirRoman};
    ...
    .sitemap {
      ...
      border-top-color  : ${state.theme.colors.mediumgrey2};
    }
    .footerlink         {
      padding-right     : 50px;
      text-decoration   : none;
    ...
    return h('div', { className: s('.footer') }, [
      h('div', { className: s('.footercontent') }, [
        ...
        h('div', { className: s('.impressum') }, [
          'the red lab UG  (haftungsbeschränkt)', h('br'),
          'Schlegelstr. 30', h('br'),
          '10115 Berlin', h('br'),
          'Telefon: 0170 7600 280', h('br'),
          'E-Mail: kontakt@theredlab.com', h('br'),
          'www.theredlab.com', h('br')
        ]),
